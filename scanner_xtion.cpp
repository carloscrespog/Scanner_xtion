...
void gimmeDaFrame(Client &MyClient){
      ...
      output_stream << "Frame Number: " << _Output_GetFrameNumber.FrameNumber << endl;
      // Get the timecode
      ...
      output_stream << "Timecode: "
                ...
                << _Output_GetTimecode.UserBits            << endl << endl;
      ...
      for( unsigned int LatencySampleIndex = 0 ; LatencySampleIndex < MyClient.GetLatencySampleCount().Count ; ++LatencySampleIndex )
      {
        ...
        output_stream << "  " << SampleName << " " << SampleValue << "s" << endl;
      }
      output_stream << endl;

      // Count the number of subjects
      unsigned int SubjectCount = MyClient.GetSubjectCount().SubjectCount;
      output_stream << "Subjects (" << SubjectCount << "):" << endl;
...
void connectToVicon(string hostname){
  ...
  // Make a new client
    ...
    cout << "Segment Data Enabled: "          << Adapt( MyClient.IsSegmentDataEnabled().Enabled )         << endl;
    cout << "Marker Data Enabled: "           << Adapt( MyClient.IsMarkerDataEnabled().Enabled )          << endl;
    cout << "Unlabeled Marker Data Enabled: " << Adapt( MyClient.IsUnlabeledMarkerDataEnabled().Enabled ) << endl;
    cout << "Device Data Enabled: "           << Adapt( MyClient.IsDeviceDataEnabled().Enabled )          << endl;
